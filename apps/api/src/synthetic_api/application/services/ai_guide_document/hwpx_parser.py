...
# =============================================================================
# 파일명: hwpx_parser.py
# 경로: apps/api/src/synthetic_api/application/services/ai_guide_document/hwpx_parser.py
# 목적: HWPX 한글 표준 문서를 분석하여 IR 트리로 파싱함
# 작성자: AI Agent
# 작성일: 2026-09-13
# 수정일: 2026-09-14
# =============================================================================
"""AI-guide-owned snapshot of synthesis HWPX parsing (2026-09-16).

Behavior is copied; IR and low-level utilities remain shared dependencies.
Do not route guide parsing through the synthesis parser class.
"""
...
from synthetic_engine.document_conversion.parsers.common import check_table_size, image_from_bytes, table_source_refs
...
from synthetic_engine.document_conversion.core.enums import ParagraphAlign
from synthetic_engine.document_conversion.geometry.table_geometry import validate_spans
from synthetic_engine.document_conversion.exceptions import DocumentConversionError
