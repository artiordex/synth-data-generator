...
# 목적: 정형 데이터 합성 작업 실행 및 파라미터 제어 API 엔드포인트를 제공함.
# 작성자: AI Agent
# 작성일: 2026-09-13
# 수정일: 2026-09-13
# =============================================================================
...
# 다양한 합성 알고리즘 모델 간 성능 및 충실도 지표를 비교함
...
# 정형 데이터 합성 파이프라인 작업을 등록하고 비동기 실행을 시작함
