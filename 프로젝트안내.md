...
[운영 가이드](docs/심의자료생성및배포.md)를 참고하세요.

기능 개선 순서와 임시 파일 정리 기준은 [개선 작업 목록](docs/architecture/개선작업목록.md)을 참고하세요.
...
모듈 경계와 실행 흐름은 [아키텍처 문서](docs/architecture/아키텍처.md), 의존성의 역할과 갱신 기준은 [라이브러리 목록](라이브러리목록.md), 변경 내역은 [개발이력](개발이력.md)에서 확인할 수 있습니다.
